...
public class Dashboard extends JFrame{
    ...
    public Dashboard() {
        ...
        ImageIcon i1 = new ImageIcon(ClassLoader.getSystemResource("hotel_management_system\\icon\\3.jpg"));
	...
	NewLabel.setBounds(0, 0, 1400, 800); 
        ...
        JLabel AirlineManagementSystem = new JLabel("<html><body><u>WELCOME</u></body></html>");
